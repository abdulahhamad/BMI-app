  ...
  render() {
    return (
      <div className="wrapper">
        <h1> Vücut Kitle İndeksi  (BMI) </h1>
        <p>
          Sağlıklı bir ağırlıkta olup olmadığını belirlemek için aşağıdaki
          bilgileri girin ve Vücut Kitle İndeksinizi (BMI) hesaplayın.
        </p>
        <table>
          <tr>
            <td>
